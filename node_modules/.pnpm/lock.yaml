...
importers:
  ...
  packages/vec:
    ...
    devDependencies:
      ...
      vitest:
        specifier: ^3.2.4
        version: 3.2.4(@types/node@20.19.11)(tsx@4.20.4)
...
packages:
  ...
  '@zilliz/milvus2-sdk-node@2.6.0':
    resolution: {integrity: sha512-0Pblc9WZXWWkEazDFTAHKEi93Bw20ErD1R62/59ZWo2TQcIQM4TP36Tu0x2Y/y+d1j6ot6CpgqfoC5Rub9DSxA==}
...
snapshots:
  ...
  '@vitest/mocker@3.2.4(vite@7.1.3(@types/node@20.19.11)(tsx@4.20.4))':
    dependencies:
      '@vitest/spy': 3.2.4
      estree-walker: 3.0.3
      magic-string: 0.30.18
  ...
  openai@5.15.0(zod@3.25.76):
    optionalDependencies:
      zod: 3.25.76

  openai@5.15.0(zod@4.1.0):
    optionalDependencies:
      zod: 4.1.0
  ...
  vite-node@3.2.4(@types/node@20.19.11)(tsx@4.20.4):
    dependencies:
      cac: 6.7.14
      debug: 4.4.1
      es-module-lexer: 1.7.0
  ...
  vitest@3.2.4(@types/node@20.19.11)(tsx@4.20.4):
    dependencies:
      '@types/chai': 5.2.2
      '@vitest/expect': 3.2.4
      '@vitest/mocker': 3.2.4(vite@7.1.3(@types/node@20.19.11)(tsx@4.20.4))
