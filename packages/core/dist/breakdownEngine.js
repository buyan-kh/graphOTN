...
export class BreakdownEngine {
            ...
            nodes: [
                {
                    ...
                    prompt_text: "Build end-to-end IoT data pipeline from sensors to warehouse",
                    children: [
                        "setup_kafka_broker",
                ...
                },
                {
                    ...
                    prompt_text: "Deploy and configure Apache Kafka broker with proper topics for IoT sensor data ingestion",
                ...
                },
                {
                    ...
                    prompt_text: "Implement Spark Structured Streaming application to consume IoT events from Kafka topics",
                    parent: "iot_pipeline_root",
                    children: [],
                ...
                },
                {
                    ...
                    prompt_text: "Apply data transformations, filtering, and enrichment to raw IoT sensor events",
                    parent: "iot_pipeline_root",
                    children: [],
                ...
                },
                {
                    ...
                    prompt_text: "Create data sink that writes cleaned and transformed IoT data to Snowflake tables with proper schema",
                    parent: "iot_pipeline_root",
                    children: [],
                ...
                },
                {
                    ...
                    prompt_text: "Deploy monitoring stack with metrics, logs, and alerts for the IoT data pipeline",
                    parent: "iot_pipeline_root",
                    children: [],
                    requires: [],
                ...
                },
                {
                    ...
                    prompt_text: "Implement data validation checks and quality monitoring for IoT sensor data",
                    parent: "iot_pipeline_root",
                    children: [],
                ...
                },
                {
                    ...
                    prompt_text: "Build REST API endpoints to query and retrieve IoT data from the warehouse",
                    parent: "iot_pipeline_root",
                    children: [],
                    requires: ["warehouse_loaded"],
                ...
                },
                {
                    ...
                    prompt_text: "Build interactive dashboard to visualize IoT sensor data and pipeline metrics",
                    parent: "iot_pipeline_root",
                    children: [],
        ...
        return {
            ...
            nodes: [
                ...
                },
                {
                    ...
                    prompt_text: "Initialize project with build tools, dependencies, and folder structure",
                ...
                },
                {
                    ...
                    prompt_text: "Build responsive navigation header with logo and menu items",
                    parent: "landing_page_root",
                    children: [],
                ...
                },
                {
                    ...
                    prompt_text: "Build compelling hero section with headline, description, and CTA button",
                    parent: "landing_page_root",
                    children: [],
                    requires: ["project_setup"],
                ...
                },
                {
                    ...
                    prompt_text: "Build features section highlighting key product benefits with icons",
                    parent: "landing_page_root",
                    children: [],
                    requires: ["project_setup"],
                ...
                },
                {
                    ...
                    prompt_text: "Build footer section with links, social media, and contact information",
                    parent: "landing_page_root",
                    children: [],
                    requires: ["project_setup"],
     ...
     * Generic breakdown for other prompts
     */
    getGenericBreakdown(prompt, mode, maxNodes) {
        ...
        return {
            ...
            nodes: [
                ...
                },
                {
                    ...
                    prompt_text: "Implement the core solution based on analyzed requirements",
                    parent: rootId,
                    children: [],
                ...
                },
                {
                    ...
                    prompt_text: "Create and run tests to verify the solution works correctly",
                    parent: rootId,
                    children: [],
     ...
     */
    convertToGoTNNodes(llmNodes, projectId) {
     ...
     */
    async createParentChildEdges(nodes) {
        const edges = [];
        const currentTime = new Date().toISOString();
    ...
    async breakdown(request) {
        ...
        try {
            ...
            const parentChildEdges = await this.createParentChildEdges(validatedNodes);
            let edgeCount = 0;
            ...
            console.log(`Breakdown complete: ${createdNodeIds.length} nodes, ${edgeCount} edges total`);
            return {
 ...
 */
let defaultBreakdownEngine = null;
export function getBreakdownEngine() {
